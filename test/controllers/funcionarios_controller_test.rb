...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { cpf: @funcionario.cpf, data_admissao: @funcionario.data_admissao, email: @funcionario.email, endereco: @funcionario.endereco, nome: @funcionario.nome } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cpf: @funcionario.cpf, data_admissao: @funcionario.data_admissao, email: @funcionario.email, endereco: @funcionario.endereco, nome: @funcionario.nome } }
